...
```bash
curl -s https://raw.githubusercontent.com/topvalue/m2alectric_docker/main/lib/onelinesetup | bash -s -- magento2.dev 2.3.4
```
...
curl -s https://raw.githubusercontent.com/topvalue/m2alectric_docker/main/lib/template | bash
